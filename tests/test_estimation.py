...
class TestEstimation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Resources
        self.fmu_path = os.path.join('tests', 'resources', 'simple2R1C_ic', 'Simple2R1C_ic_{}.fmu'.format(platform))
        inp_path = os.path.join('tests', 'resources', 'simple2R1C_ic', 'inputs.csv')
        ideal_path = os.path.join('tests', 'resources', 'simple2R1C_ic', 'result.csv')
        est_path = os.path.join('tests', 'resources', 'simple2R1C_ic', 'est.json')
        known_path = os.path.join('tests', 'resources', 'simple2R1C_ic', 'known.json')
